...
export const Card = ({ title, image, body, stack, onClick }) => {
    ...
    return (
        <div onClick={onClick}
            className={"flex gap-4 flex-col w-full md:w-[320px] hover:scale-105 transition bg-white p-4 rounded-lg items-center cursor-pointer gap-2 shadow h-[425px] justify-between"}
        >
