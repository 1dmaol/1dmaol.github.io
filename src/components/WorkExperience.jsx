			...
			>
				...
				<ul id="journey" className="flex gap-4 flex-col md:pl-8 border-l-2 border-gray-400">
					{sections.reverse().map((section) => {
						return (
							<WorkExperienceCard section={section} isSelected={selected.index === section.index} />
						)
					})}
...
const WorkExperienceCard = ({ section, isSelected }) => {
	return (
		<div className={"py-4 px-6 w-fit md:w-[750px] md:mx-auto"} key={section.index}>
